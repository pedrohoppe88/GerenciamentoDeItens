...
/*    .button {
   ...
   <button id="join-group" class="button" data-toggle="modal" data-target="#joinGroupModal">Entrar em um Grupo Existente</button>
...
<div class="container">
  ...
  <div class="btnClass">
  <a href="pageNewGroup.php" class="btn btn-primary">Go to Google</a>
