...
/* Newsletter Signup */
.bg-light {
    background-color: #f9f9f9 !important; /* Slightly different light gray for differentiation */
}
...
.container {
    margin-bottom: 60px; /* Increasing spacing between sections */
}
...
.carousel-caption {
    padding: 20px;  /* Adicionando padding para uma melhor visualização do texto sobre as imagens */
}

.custom-card:hover {
    transform: translateY(-5px);  /* Reduzindo o efeito hover nos cards para ser mais sutil */
}
...
section {
    margin-top: 100px;  /* Aumenta a margem superior para cada seção */
}
    ...
    <div id="customCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fwww.dayzrp.com%2Fuploads%2Fmonthly_2018_11%2FDlQvdTqW4AInjYs.jpg.d5a9ca254a5a5610c486778973dd03f5.jpg&f=1&nofb=1&ipt=3e99f936e50471a14b138e47fe3c2c8349826b66157742fd6d71ed14fb56e2c2&ipo=images" alt="Image 1" class="d-block w-100 img-fluid">
            ...
            <div class="carousel-item">
                <img src="https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fwallpapercave.com%2Fwp%2Fwp1886441.jpg&f=1&nofb=1&ipt=29382288f4b1fbaa94ea5dd567b3691ebd63967643b711e140cb5e75e03acf1b&ipo=images" alt="Image 2" class="d-block w-100">
                <div class="carousel-caption">
...
<div class="container mt-5 text-center">
    ...
    <a href="#" class="btn btn-primary btn-lg">Cadastre-se agora</a>
</div>
